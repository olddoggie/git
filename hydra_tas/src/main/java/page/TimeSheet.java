...
public class TimeSheet {
    ...
    public static WebElement ts_submitlink = BasePage.driver.findElement(By.id("bt-submit")); // Cannot be called in @AfterMethod when week is NOT this week
    ...
    public void InputData(WebDriver driver,String first, String sec_1,String sec_2,
        ...
        _col_1.click();
        WebElement  __col_1;
        if ( first.equalsIgnoreCase("Bleum") || first.equalsIgnoreCase("ODC:Falcon") ) {
            __col_1 = driver.findElement(By.linkText(first));
        }
        else {
            __col_1 = driver.findElement(By.linkText("WS:"+first));
        }
        __col_1.click();
