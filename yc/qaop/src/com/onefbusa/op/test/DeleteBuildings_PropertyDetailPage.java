...
public class DeleteBuildings_PropertyDetailPage {
    ...
    @Test(groups = { "BAT" }, description = ("test confirm box when agent's gonna Remove Building in Property Detail page"))
    public void CP_222_9_1() throws Exception{
        PropertyDetailPage.removeBuildingFromUnitBlocks_btn1.click();
        verifyMultipleElementsPresent(PropertyDetailPage.deleteConfirmElements);
        PropertyDetailPage.deleteConfirmPopUpBox_content.verifyContainsIgnoreSpaces("Are you sure you want to delete this building?");
    }

    @Test(groups = { "BAT" }, dependsOnMethods = {"CP_222_9_1"},
            description = ("test Remove Building in Property Detail page"))
    public void CP_222_9_7() throws Exception{
        PropertyDetailPage.removeBuildingFromUnitBlocks_btn1.click();
        PropertyDetailPage.deleteConfirmPopUpBox_no.waitUntilElementPresent().click();
        Thread.sleep(500);   // wait for pop up box disappear
        PropertyDetailPage.buildingNameInUnitBlocks_title1.verifyElementPresent();
        PropertyDetailPage.removeBuildingFromUnitBlocks_btn1.click();
        PropertyDetailPage.deleteConfirmPopUpBox_yes.waitUntilElementPresent().click();
        PropertyDetailPage.buildingNameInUnitBlocks_title1.waitUntilElementDisappearByTime(20).verifyElementNotPresent(); // wait at most 20s until system detect building has been deleted
        PropertyDetailPage.buildingName_displayValue.verifyElementNotPresent();
        PropertyDetailPage.buildingType_selectBox.verifyElementNotPresent();
    }
