...
public class RemoveTenant {
    ...
    public void setupBeforeClass(String browser) throws Exception {
        ...
        LeaseDetailPage.addAnotherTenant_btn.click();
    }

    @Test(groups = { "BAT" }, description = ("test remove tenant of Tenant Info table in Lease Detail Page"))
    public void CP_211b_3_1 () throws Exception{
        LeaseDetailPage.tenantTab_link2.verifyElementPresent();
        LeaseDetailPage.removeTenant_btn.click();
        LeaseDetailPage.tenantTab_link2.verifyElementNotPresent();
