...
public class ShowTop5EndingSoonLeases {
    ...
    @Test(groups = { "BAT" }, description = ("test Lease Ending Soon top 5 table in agent dashboard page"))
    public void CP_200_2_1() throws Exception{
        AgentDashboardPage.leaseEndingSoon_tableTitle.verifyContainsIgnoreSpaces("LEASES ENDING SOON");
        verifyMultipleElementsPresent(AgentDashboardPage.leaseEndingSoonTableElements);
        AgentDashboardPage.leaseEndingSoon_innerItem_1.verifyContainsIgnoreSpaces(TestData.LeaseEndingSoonTable_in_agent_dashboard);
    }
