...
public class ViewPropertyInfo {
    ...
    @Test(groups = { "BAT" }, description = ("test Property Info table in Lease Detail page"))
    public void CP_211_5_1() throws Exception{
        verifyMultipleElementsPresent(LeaseDetailPage.propertyInfoTableElements);
